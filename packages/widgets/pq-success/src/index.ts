...
const trophyIcon = html`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
...
const burstIllustration = html`
  <svg viewBox="0 0 600 280" width="100%" height="280" aria-hidden="true">
    <g class="burst__rays">
      <line x1="300" y1="140" x2="300" y2="20" stroke="var(--arc-display-bright, #FFEE5C)" stroke-width="4" stroke-linecap="round" />
      <line x1="300" y1="140" x2="380" y2="40" stroke="var(--cat-pink, #FF3FA4)" stroke-width="4" stroke-linecap="round" />
      <line x1="300" y1="140" x2="440" y2="100" stroke="var(--cat-purple, #8E47E8)" stroke-width="4" stroke-linecap="round" />
      <line x1="300" y1="140" x2="460" y2="180" stroke="var(--cat-blue, #3D8BF5)" stroke-width="4" stroke-linecap="round" />
      <line x1="300" y1="140" x2="380" y2="240" stroke="var(--arc-success, #34D670)" stroke-width="4" stroke-linecap="round" />
      <line x1="300" y1="140" x2="220" y2="240" stroke="var(--cat-orange, #FF8C2C)" stroke-width="4" stroke-linecap="round" />
      <line x1="300" y1="140" x2="140" y2="180" stroke="var(--arc-display-bright, #FFEE5C)" stroke-width="4" stroke-linecap="round" />
      <line x1="300" y1="140" x2="160" y2="100" stroke="var(--cat-pink, #FF3FA4)" stroke-width="4" stroke-linecap="round" />
      <line x1="300" y1="140" x2="220" y2="40" stroke="var(--cat-teal, #2DD4BF)" stroke-width="4" stroke-linecap="round" />
    </g>
    ...
    <rect x="520" y="200" width="12" height="12" fill="var(--arc-success, #34D670)" transform="rotate(25 526 206)" />
    <rect x="70" y="140" width="10" height="10" fill="var(--cat-blue, #3D8BF5)" transform="rotate(-15 75 145)" />
    <circle cx="540" cy="140" r="5" fill="var(--cat-orange, #FF8C2C)" />
    <rect x="200" y="20" width="8" height="14" fill="var(--arc-display-bright, #FFEE5C)" transform="rotate(30 204 27)" />
    <rect x="400" y="20" width="8" height="14" fill="var(--cat-pink, #FF3FA4)" transform="rotate(-30 404 27)" />
    ...
    <g class="burst__trophy" transform="translate(300 140) scale(1.2)">
      <path d="M-40 -40 L40 -40 L36 30 Q32 50 0 50 Q-32 50 -36 30 Z" fill="var(--arc-display-bright, #FFEE5C)" stroke="var(--cat-orange, #FF8C2C)" stroke-width="3" />
      ...
      <path d="M-13 12 L-3 19 L13 -4" fill="none" stroke="var(--arc-bg-deep, #15042E)" stroke-width="5" stroke-linecap="round" stroke-linejoin="round" />
    </g>
  </svg>
`;
...
export class PqSuccess extends LitElement {
  ...
  constructor() {
    ...
    bindAtom(this, $claims, (claims, host) => {
      ...
      if (latest.value != null) self.shipMeta = `Retail value $${latest.value} · ships to your address on file`;
    });
  }
  ...
  override render(): TemplateResult {
    ...
    return html`
      <div class="wrap">
        ...
        <h1 class="title">
          ${this.heading ?? html`You won <em>${this.prizeName}</em>`}
        </h1>
        <p class="sub">Shipping to your address on file. Track it from your prize history.</p>
        ${this.referenceCode
          ? html`<button class="ref" @click=${this.handleCopy}>${this.referenceCode} ${copyIcon}</button>`
          : nothing}
        <div class="card">
      ...
      <div class="wrap wrap--expanded">
        ...
        <div class="order">
          ...
          <div class="order__info">
            ...
            ${this.referenceCode
              ? html`<button class="order__ref" @click=${this.handleCopy}>${this.referenceCode} ${copyIcon}</button>`
              : nothing}
        ...
        <div class="actions actions--row">
          <button class="cta cta--xl" @click=${this.handleCta}>${this.ctaLabel} ${checkIcon}</button>
          <button class="cta cta--ghost cta--xl" @click=${this.handleDismiss}>${this.dismissLabel}</button>
        </div>
      </div>
    `;
  }
  ...
  private handleCopy = (event?: Event): void => {
    ...
    this.dispatchEvent(
      new CustomEvent("pq-copy", { detail: { value: this.referenceCode ?? "" }, bubbles: true, composed: true }),
    );
  };
