...
export const arcadePrizes: Prize[] = [
  ...
  { id: "yeti-rambler-64", name: "YETI Rambler 64oz", category: "outdoor", value: 110, inStock: true, prizeType: "physical" },
  { id: "amazon-100", name: "$100 Amazon Gift Card", category: "gift-cards", value: 100, inStock: true, prizeType: "digital" },
  { id: "vegas-trip", name: "Vegas Trip Package", category: "travel", value: 1500, inStock: true, prizeType: "physical" },
  { id: "topgolf-vip", name: "Topgolf VIP Day", category: "sports", value: 320, inStock: true, prizeType: "physical" },
  { id: "galaxy-tab-s9", name: "Samsung Galaxy Tab S9", category: "electronics", value: 800, inStock: true, prizeType: "physical" },
  { id: "sony-wh1000", name: "Sony WH-1000XM5", category: "audio", value: 400, inStock: true, prizeType: "physical" },
  { id: "echo-show-15", name: "Amazon Echo Show 15", category: "smart-home", value: 280, inStock: true, prizeType: "physical" },
];
...
export const arcadeCampaigns: Campaign[] = [
  {
    ...
    goal: 500,
    pct: 100,
    meta: "$500 / $500 · Every Sunday in June 2026",
    expiresAt: "2026-06-30",
    prizeIds: ["airpods-pro", "yeti-rambler-64", "amazon-100"],
    prizePool: 459,
    frequency: "Weekly",
  ...
  },
  {
    ...
    goal: 5000,
    pct: 64,
    meta: "$3,200 / $5,000 · Through July 4, 2026",
  ...
  },
  {
    ...
    goal: 1000,
    pct: 73,
    meta: "$725 / $1,000 · Through July 31, 2026",
  ...
  },
  {
    ...
    goal: 300,
    pct: 100,
    meta: "$300 / $300 · Daily in June 2026",
    expiresAt: "2026-06-30",
  ...
  },
  {
    ...
    goal: 4000,
    pct: 45,
    meta: "$1,800 / $4,000 · Through Aug 2026",
...
export const arcadeOrders: (Order & { imageSeed: string; category: string })[] = [
  { id: "PQ-26-7842-9F12", prizeName: "Beats Studio Pro", campaignName: "Sunday Slot Sprint", status: "delivered", claimedAt: "May 12, 2026", confirmation: "PQ-26-7842-9F12", value: 349, imageSeed: "beats-studio-pro", category: "electronics" },
  { id: "PQ-26-7842-A5C3", prizeName: "$50 DoorDash Gift", campaignName: "VIP Game Day Quest", status: "shipped", claimedAt: "May 28, 2026", confirmation: "PQ-26-7842-A5C3", tracking: "1Z999AA10123456784", carrier: "UPS Ground", value: 50, imageSeed: "doordash-gift", category: "gift-cards" },
  { id: "PQ-26-7842-B7D8", prizeName: "Apple AirTags 4-Pack", campaignName: "Sunday Slot Sprint", status: "in-transit", claimedAt: "Jun 2, 2026", confirmation: "PQ-26-7842-B7D8", value: 99, imageSeed: "airtags-4pack", category: "electronics" },
  { id: "PQ-26-7842-4E91", prizeName: "YETI Tumbler 30oz", campaignName: "Sunday Slot Sprint", status: "delivered", claimedAt: "Apr 18, 2026", confirmation: "PQ-26-7842-4E91", value: 45, imageSeed: "yeti-tumbler-30", category: "outdoor" },
  { id: "PQ-26-7842-2D88", prizeName: "$100 Amazon Gift", campaignName: "Sunday Slot Sprint", status: "delivered", claimedAt: "Mar 11, 2026", confirmation: "PQ-26-7842-2D88", value: 100, imageSeed: "amazon-100", category: "gift-cards" },
  { id: "PQ-26-7842-1A47", prizeName: "Ray-Ban Aviator", campaignName: "Sunday Slot Sprint", status: "delivered", claimedAt: "Feb 3, 2026", confirmation: "PQ-26-7842-1A47", value: 165, imageSeed: "rayban-aviators", category: "wellness" },
  { id: "PQ-26-7842-3B72", prizeName: "Sony WH-1000XM5", campaignName: "VIP Electronics Quest", status: "delivered", claimedAt: "Jan 22, 2026", confirmation: "PQ-26-7842-3B72", value: 400, imageSeed: "sony-wh1000", category: "electronics" },
  { id: "PQ-26-7842-6C44", prizeName: "Topgolf VIP Day", campaignName: "VIP Game Day Quest", status: "delivered", claimedAt: "Jan 9, 2026", confirmation: "PQ-26-7842-6C44", value: 320, imageSeed: "topgolf-vip", category: "sports" },
  { id: "PQ-26-7842-8AD1", prizeName: "$25 Starbucks Gift", campaignName: "Sunday Slot Sprint", status: "shipped", claimedAt: "Dec 28, 2025", confirmation: "PQ-26-7842-8AD1", tracking: "1Z999AA10987654321", carrier: "UPS Ground", value: 25, imageSeed: "starbucks-gift", category: "gift-cards" },
  { id: "PQ-26-7842-D90F", prizeName: "Hydro Flask 32oz", campaignName: "Sunday Slot Sprint", status: "delivered", claimedAt: "Dec 14, 2025", confirmation: "PQ-26-7842-D90F", value: 45, imageSeed: "hydro-flask-32", category: "outdoor" },
  { id: "PQ-26-7842-5E23", prizeName: "Apple AirPods Pro", campaignName: "VIP Electronics Quest", status: "delivered", claimedAt: "Nov 30, 2025", confirmation: "PQ-26-7842-5E23", value: 249, imageSeed: "airpods-pro", category: "electronics" },
  { id: "PQ-26-7842-7E10", prizeName: "Echo Show 15", campaignName: "VIP Electronics Quest", status: "delivered", claimedAt: "Nov 16, 2025", confirmation: "PQ-26-7842-7E10", value: 280, imageSeed: "echo-show-15", category: "smart-home" },
];
