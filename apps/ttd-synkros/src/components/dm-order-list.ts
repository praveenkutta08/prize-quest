    ...
    return html`
      <div class="root">
        <div class="head">
          ...
          <div class="head__mid">
            ${trophyIcon}
            <!-- No eyebrow here. A prize screen needs the campaign name for context;
                 order history is self-describing, and "YOUR AC..." truncated in the
                 1024 header taught nobody anything. -->
            <span class="head__title">Order history</span>
          </div>
          ${this.renderMark()}
        </div>
