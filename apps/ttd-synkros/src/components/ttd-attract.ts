...
export class TtdAttract extends LitElement {
  static override styles = css`
    ...
    .attract-card {
      ...
      height: 50px;
      border-radius: 6px;
      background: linear-gradient(135deg, var(--cat-purple-deep, #6b2dd0), var(--cat-pink-deep, #e91e63), var(--cat-purple, #8e47e8));
  ...
  private declare _teaserIndex: number;
  private declare _teaserVisible: boolean;
  #teaserTimer?: number;
